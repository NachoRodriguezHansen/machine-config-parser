function Get-SeriesInfo {
    ...
    switch ($SeriesPrefix) {
        ...
        "TX6xx" {
            ...
            $CspFiles = @("ControlUnit\1_MachineConfiguration.csp")
            $MuConfigFile = "ControlUnit\MU_Config.TcGVL"
            $OutFileName = "TX6xx_machines_v00.xml"
        }
        default {
            throw "Invalid series prefix '$SeriesPrefix'. Supported: W5xx, T30x, TX6xx."
        }
    }
...
Export-ModuleMember -Function Get-SeriesInfo
